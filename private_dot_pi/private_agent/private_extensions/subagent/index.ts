 ...
 *
 * This is the thin entry module: it defines the tool schema, dispatches the
 * three execution modes, and registers the tool. Subprocess execution lives in
 * spawn.ts, rendering in render.ts, pure result helpers in result.ts, model
 * selection in model-selection.ts, and agent discovery in agents.ts.
 */
...
export default function (pi: ExtensionAPI) {
	pi.registerTool({
		...
		renderResult: (result, options, theme, _context) => renderSubagentResult(result, options, theme),
	});
}
